...
const DailyEntryTurn2 = () => {
  ...
  const {
    turnData: turn2,
    setTurnData: setTurn2,
    updateProduct: updateTurn2Product,
    manualSave,
  } = useSingleTurnData({ products, coffeeTypes, selectedDate, turnNumber: 2 });
  ...
  }, [editedProductName, updateProduct, cancelEditingProduct, setTurn2]);
  ...
  const handleSave = useCallback(() => {
    manualSave();
    toast.success(`Të dhënat u ruajtën! Xhiro: ${turn2.xhiro.toLocaleString()} ALL`);
  }, [manualSave, turn2.xhiro]);
    ...
    <Layout>
      <div className="space-y-6 pb-20 md:pb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-foreground">Turni 2</h2>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex justify-between items-center">
              <p className="text-sm text-muted-foreground">Xhiro Turni 2</p>
              <p className="text-2xl font-bold">{turn2.xhiro.toLocaleString()} ALL</p>
            </div>
          </CardContent>
        </Card>
...
export default DailyEntryTurn2;
